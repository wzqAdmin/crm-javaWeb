...
<script type="text/javascript" src="jquery/bs_typeahead/bootstrap3-typeahead.min.js"></script>
 ...
 <script type="text/javascript">
	 $(function () {
			 ...
			 source: function (query, process) {
				 $.get(
						 ...
						 function (data) {
							 ...
							 /*
							    需要后端返回什么？
							      不能返回市场活动对象集合，因为这个插件无法解析我们的对象，应该返回String类型的字符串
							  */
							 process(data);
						 },
						 "json"
		 ...
		 /*------------------------------------------------------*/
		 //为阶段绑定事件，当阶段被选中的时候，相应的可能性会自动被获取出来
		 $("#create-transactionStage").change(function () {
			 //获取用户选择的交易阶段 即pMap中的key
...
<body>
	...
	<form class="form-horizontal" id="saveTranForm" action="workbench/transaction/save.do" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="公司电脑采购">
				<input type="hidden" value="fa82bac06102497687464e1f2711fa36" name="activityId">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="a076fb02b5404d139b2da4a20d4c27c1" name="contactsId">
			</div>
		</div>
